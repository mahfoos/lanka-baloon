...
const know = [
  { title: "Weather", body: "Flights depend on good weather and the pilot can cancel at any time. If we cancel, you get a full refund — or join the next day's flight if there's space." },
  ...
  { title: "Children", body: "We generally fly children aged 6 and up, with a responsible adult. Younger children may fly when conditions are excellent — ask us first." },
  ...
  return (
    <>
      ...
      <section className="container-x grid gap-12 py-20 sm:py-28 md:grid-cols-2 md:items-center">
        ...
        <Reveal delay={120}>
          <h2 className="text-3xl sm:text-4xl">Optional photo and video package</h2>
          <p className="mt-4 text-lg text-ink-soft">
            Pilots may record your flight with in-flight cameras. After landing you can buy the files directly from them — it&rsquo;s an independent add-on, and prices vary.
          </p>
        </Reveal>
      </section>
      ...
      <section className="border-t border-line">
        <div className="container-x py-20 sm:py-28">
          ...
          <Link href="/faq" className="mt-10 inline-block font-semibold text-flame underline underline-offset-4">Read the full FAQ</Link>
        </div>
      </section>
