...
export const stats: { to: number; suffix?: string; label: string; count?: boolean }[] = [
  ...
  { to: 56, label: "Seats across the fleet" },
...
export const faqs: { q: string; a: string; topic: FaqTopic; image?: ImageKey }[] = [
  ...
  { q: "What should I wear and bring?", topic: "Before you fly", image: "faqFriends",
    a: "Comfortable low-heeled shoes, sunglasses and a hat. Bring your camera or phone, and our crew will help you capture the moment." },
...
export const gettingHere = [
  { from: "Colombo", options: "Fly Cinnamon Air (CMB → Sigiriya), take the train to Habarana (2 a day), or an A/C bus, about 170 km and 4 hours. A taxi is around LKR 20,000." },
